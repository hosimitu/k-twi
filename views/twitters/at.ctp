...
<?php
$ktai->emoji(0xE6E3);
echo $html->link('更新する', '/twitters/at', array('accesskey' => 1));
?>
<br />
<?php
$ktai->emoji(0xE6E4);
...
<?php if ($page >= 2) {
$ktai->emoji(0xE6E8);
echo $html->link("前ページへ", "/twitters/at/".($page - 1), array('accesskey' => 7));
echo "<br />";
} ?>
</small></span>
...
<?php if ($page <= 9) {
$ktai->emoji(0xE6EA);
echo $html->link("次ページへ", "/twitters/at/".($page + 1), array('accesskey' => 9));
} ?>
</small></span>
<br />
<?php 
...
echo $form->create("", array('action' => 'at'));
?>
ページ：
<?php
