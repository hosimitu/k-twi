...
<?php
$ktai->emoji(0xE6E2);
echo $html->link('更新する', '/twitters', array('accesskey' => 1));
?>
<br />
<?php
$ktai->emoji(0xE6E3);
...
echo $form->create("", array('action' => 'count'));
echo $form->select('count', $data, 50, false, false);
echo $form->submit('件表示する', array('div' => false));
echo $form->end() ?>
